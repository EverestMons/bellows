# bellows — `_cleanup_verdicts_for_slug` Call-Site Gap Diagnostic
...
**Bootstrap:**
```
Read the plan at bellows/knowledge/decisions/diagnostic-cleanup-verdicts-call-site-gap-2026-05-01.md. Execute Step 1 ONLY. Single-step diagnostic — do NOT move the plan to Done. Stop and report Complete when findings are deposited.
```
...
> **FIRST — before doing anything else, claim this plan:** `import shutil; shutil.move("bellows/knowledge/decisions/diagnostic-cleanup-verdicts-call-site-gap-2026-05-01.md", "bellows/knowledge/decisions/in-progress-diagnostic-cleanup-verdicts-call-site-gap-2026-05-01.md")`.
>
