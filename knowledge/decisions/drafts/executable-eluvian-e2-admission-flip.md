...
| X4 | the six `is_runnable_plan` call sites | bellows.py:2053, :2065, :2220, :2346, :2622, :2702 | per the design's G1 table: FOUR become `is_claimable` (2053/2065/2346/2702), TWO stay bare (2220/2622) — the classification and both failure modes are IN the design; re-verify the line numbers against your X2 tree, and if they drifted, locate by the design's context descriptions, never by number |
