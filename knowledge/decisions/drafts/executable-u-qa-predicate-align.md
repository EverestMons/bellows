...
**Walks:** 2 (walks 0–2 complete; the cycle is open).
- Weak spots:          w1 2 folded — instruction 2 / record 0; w2 2 folded — instruction 1 / record 1.
- Destruction:         w1 1 folded — instruction 1 / record 0; w2 1 folded — instruction 1 / record 0.
- Vulnerabilities:     w1 2 folded — instruction 2 / record 0; w2 2 folded — instruction 2 / record 0.
- Integration-record:  w1 3 folded — instruction 2 / record 1; w2 2 folded — instruction 1 / record 1.
- ACID:                w1 2 folded — instruction 2 / record 0; w2 2 folded — instruction 2 / record 0.
...
**Per-walk yields:** w0 3 (instruction 2 / record 1) · w1 10 (instruction 9 / record 1; 1 fold-introduced) · w2 9 (instruction 7 / record 2; **5 fold-introduced**). ⚠️ The fold-introduced share is 56% at walk 2 — the noise-floor signature §2 names, a reason to suspect circling and not a licence to close. The countervailing fact is that two of walk 2's findings were unreachable by reading: the test-first split and the fire ratio were both wrong until a command was run.
...
**Closing:** the cycle is open; walk 2 left seven instruction-class findings; no close claimed.
