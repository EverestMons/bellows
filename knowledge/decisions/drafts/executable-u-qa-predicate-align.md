...
**Per-walk yields:** w0 3 (instruction 2 / record 1) · w1 10 (instruction 9 / record 1; 1 fold-introduced) · w2 9 (instruction 7 / record 2; 5 fold-introduced) · w3 10 (instruction 10 / record 0; 4 fold-introduced) · w4 4 (instruction 4 / record 0; 1 fold-introduced) · **cold scout 12 folded (instruction 5 / record 7), 3 further rows stale-but-confirming** · w5 10 (instruction 2 / record 8; 8 fold-introduced) · **class enumeration (declared non-walk) 1 (instruction 1 / record 0; 1 fold-introduced)** · w6 2 (instruction 2 / record 0; 1 fold-introduced). ⚠️ The fold-introduced share is 56% at walk 2 — the noise-floor signature §2 names, a reason to suspect circling and not a licence to close. The countervailing fact is that two of walk 2's findings were unreachable by reading: the test-first split and the fire ratio were both wrong until a command was run.
