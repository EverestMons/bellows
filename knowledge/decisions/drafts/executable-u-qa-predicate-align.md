...
**Walks:** 1 (walk 0 and walk 1 complete; the cycle is open).
...
- Integration-record:  w1 3 folded — instruction 2 / record 1.
- ACID:                w1 2 folded — instruction 2 / record 0.
...
**Per-walk yields:** w0 3 (instruction 2 / record 1) · w1 10 (instruction 9 / record 1; 1 fold-introduced).
...
**Closing:** the cycle is open; walk 1 left nine instruction-class findings; no close claimed.
