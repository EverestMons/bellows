...
| P12 | §2.0 (5) target shas | `PLANNER_TEMPLATE.md` `4172af6310e67dc4` · `LESSONS.md` `dac462624af40070` · `wrap.md` `9a2c2e11bdaf9ab1` · `eluvian.md` `218301d12677055d` | `shasum -a256` each |
