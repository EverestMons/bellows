...
| 8 | 2026-05-28 | `stop_prose` false-positive on `do not proceed` inside Rule 20 instructional prose (context in BACKLOG-ARCHIVE.md) | deferred-work | — | open |
...
| 11 | 2026-05-29 | `stop_prose` matches PLANNER_TEMPLATE-prescribed `STOP. Do NOT proceed` step-boundary language (context in BACKLOG-ARCHIVE.md) | deferred-work | — | open |
