...
**Closing:** pending — the warm cycle is closed: c1 (four lenses) dry after its three in-pass folds, then aC (ACID confirming, apart) dry at zero; the last event is a lens pass. The T2 cold panel (five seats, sequential, each its own turn; hand seats 313 and 315's Q5/Q6) is the one phase owed before deposit. Not deposited.
