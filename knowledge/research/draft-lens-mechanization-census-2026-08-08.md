...
**Closing:** NOT REACHED — c1 folded 4, so the walk is not dry and is NOT CLAIMED dry. An ACID confirming read of the c1 folds is owed apart, then a further confirming pass until one returns dry with the last event a lens pass.
